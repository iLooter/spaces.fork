    ...
    <div id="main_page">
        ...
        <div class="wrapper relative wbg" id="about_spaces">
            ...
            <div class="oh word_break pad_t_a">
                ...
                <div class="about_pic"><img src="{{ asset('/') }}/icons/about_mobile.png" alt="" width="32px"
                                            height="32px"></div>
                <div class="oh pad_b_a">
                    <div class="upcs"><b>Мобильность</b></div>
                    <div class="grey"> Сайт доступен с любых устройств, но разрабатывался специально для мобильных.
                    </div>
                </div>
                <div class="cl"/>
            </div>

            <div class="about_pic"><img src="{{ asset('/') }}/icons/about_privacy.png" alt="" width="32px"
                                        height="32px"></div>
            <div class="oh pad_b_a">
                <div class="upcs"><b>Приватность</b></div>
                <div class="grey"> Мы уважаем вашу анонимность. Никто не узнает ваш ник на Spaces, пока вы сами не
        ...
        <div class="about_pic"><img src="{{ asset('/') }}/icons/about_contacts.png" alt="" width="32px" height="32px">
        </div>
        <div class="oh">
            <div class="upcs"><b>Новые знакомства</b></div>
            <div class="grey"> Вы можете общаться не только с друзьями, но и познакомиться с массой новых интересных
                людей.
            </div>
        </div>

    </div>
    <div class="block bord-botm t_center"> Зарегистрируйтесь за 20 секунд, и сразу получите доступ ко всем возможностям
        Spaces.
    </div>
    <a href="{{ url('register') }}" class="link -full  blue c-blue   is_final">
        <span><img src="{{ asset('/') }}/icons/befriends_blue.png" alt="" class="m"><span class="m b">Зарегистрироваться</span></span>
    </a>
</div>
                ...
                <tr>
                    <td class="top break-word topi">
                        <a class="tdn gview_link" href="" g="201335108|7|1690">
                            <div class="inl_bl relative">
                                <img src="{{ asset('/') }}/icons/201335108.p.81.80.0.jpg" alt=""
                    ...
                    <td class="top break-word topi">
                        <a class="tdn gview_link" href="" g="201306378|7|1690">
                            <div class="inl_bl relative">
                                <img src="{{ asset('/') }}/icons/201306378.p.81.80.0.jpg" alt=""
                                     class="preview s81_80">
                            </div>
                        </a>
                    </td>
...
<div class="wrapper bb0">
    ...
    <div class="block bord-botm relative attaches_limiter">
        <div class="oh">
            ...
            <img src="{{ asset('/') }}/icons/users_group.png" alt="" class="m p16">
            <div class="m grey"> ~МАСАРАКШ~</div>
            <div class="cl pad_t_a"/>
        </div>
        <div class="left t-padd_right">
            <div><span class="short_attach"><div class="inl_bl"></div></span></div>
        </div>

        <div class="oh"><a class="arrow_link full_link" href=""><b>ЭНЕРГЕТИЧЕСКИЕ ПРИЧИНЫ ЗАБОЛЕВАНИЙ</b></a>
            <div> Любая болезнь является причиной нарушения баланса между человеком и Вселенной...</div>
        </div>
    </div>
    <div>
        <div class="oh">
            <div class="oh cl grey pad_t_a">
                <span class="left"><img src="{{ asset('/') }}/comm_ico.png" class="m p16" alt=""><span
                            class="m">110</span></span>
                <span class="m right"><span>Интересное в сети</span></span>
            </div>
            <div class="cl"/>
        </div>
    </div>
    ...
    <div class="title oh black relative text_left">
        <a href="http://spaces.ru/sz/?Clt=22&amp;dir=4&amp;from=main&amp;list=6"
           class="right strong_link full_link"> Все <img
                    src="{{ asset('/') }}/icons/arr_blue.png" alt="">
        </a>
                    ...
                    <td class="top break-word topi">
                        <a class="tdn gview_link"
                           href="" g="9699538|25|4|video">
                            <div class="fdw font0">
                                <div class="inl_bl relative">
                                    <img src="{{ asset('/') }}/icons/9699538.v.115.80.0.jpg" alt=""
                    ...
                    <td class="top break-word topi">
                        <a class="tdn gview_link"
                           href="" g="9696978|25|4|video">
                            <div class="fdw font0">
                                <div class="inl_bl relative">
                                    <img src="{{ asset('/') }}/icons/9696978.v.115.80.0.jpg" alt=""
                                         class="preview s115_80">
                                </div>
...
<div class="list">
            ...
            <div class="list f-c_fll">
                <div class="block oh relative bord-botm">
                    <div class="left p40">
                            <span class="pr">
                                <div class="inl_bl relative">
                                    <img src="{{ asset('/') }}/178739801.p.81.80.0.jpg" alt="" class="preview s81_80">
                                </div>
                            </span>
                    </div>
                ...
                <div class="block oh relative bord-botm">
                    <div class="left p40">
                            <span class="pr">
                                <div class="inl_bl relative">
                                    <img src="{{ asset('/') }}/86906947.p.81.80.0.jpg" alt="" class="preview s81_80">
                                </div>
                            </span>
                    </div>
                    <div class="oh pre_content_wrap">
                ...
                <div class="last">
                    <div class="block oh relative bord-botm">
                        <div class="left p40">
                                <span class="pr">
                                    <div class="inl_bl relative">
                                        <img src="{{ asset('/') }}/191039633.p.81.80.0.jpg"
                                             alt=""
                                             class="preview s81_80">
                                    </div>
                                </span>
    ...
    <div class="kdc0949" id="k4a07b1">
        <div class="k17420d oh">
            <img src="{{ asset('/') }}/icons/shut.png" class="k6ebdcf" title="Закрыть" onclick="">
            <img src="{{ asset('/') }}/icons/ofkupk.png" alt="" width="50px" height="16px">
        </div>
        <div id="k5436c8" class="kc30a38 k50abb7">
            <div id="k50abb71298205611000">
                ...
                <div/>
                <script async="" src="{{ asset('/') }}/icons/74580593191000.js"/>
            </div>

            <a href="" class="k261829"> Здесь могла бы быть ваша реклама </a>
            <div class="kce8c23"/>
        </div>
    </div>
</div>
